...
const EditorImage = () => {
  ...
  return (
    <div className=" w-screen h-screen text-black-500 flex flex-col items-center relative max-w-7xl m-auto">
      
        <h2 className='text-4xl mt-10 font-extrabold'> Editor Image SVG</h2>
